        ...
        sections = [
            {
                ...
                "models": [
                    ...
                    if model["object_name"] in section1_models
                ],
            },
            {
                "name": "shipping",
                "models": [
                    model
                    for model in app_list[0]["models"]
                    if model["object_name"] in section2_models
                ],
            },
            {
                "name": "Documents",
                "models": [
                    model
                    for model in app_list[0]["models"]
                    if model["object_name"] in section3_models
                ],
            },
            {
                "name": "Contacts",
                "models": [
                    model
                    for model in app_list[0]["models"]
                    if model["object_name"] in section4_models
                ],
            },
        ]
